        ...
        {filteredProducts.length === 0 ? (
          ...
          filteredProducts.map((product) => (
            <motion.div 
              ...
              className="bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-xl hover:shadow-gray-200/50 transition-all group flex flex-col cursor-pointer"
            ...
            >
              ...
              <div className="p-5 space-y-3 flex-1 flex flex-col">
                ...
                <div className="pt-2 mt-auto">
                  <button className="w-full text-center py-2.5 rounded-xl bg-indigo-50 text-indigo-600 text-xs font-bold group-hover:bg-indigo-600 group-hover:text-white transition-all">
                    View Details
                  </button>
                </div>
              </div>
