    ...
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <div className="bg-white p-8 md:p-10 rounded-3xl border border-gray-100 shadow-sm space-y-8">
        <div className="space-y-2">
          ...
          <p className="text-gray-500">List your product on Elibuy marketplace</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full p-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-indigo-600 transition-all min-h-[120px]"
